...
export default function Container(props) {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <nav className="flex items-center justify-between w-full max-w-4xl p-8 mx-auto my-0 text-gray-900 bg-gray-50 sticky-nav md:my-8 dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
